...
public class FLUTE
{
    ...
    {
        int[] x1 = new int[d], x2 = new int[d], y1 = new int[d], y2 = new int[d];
        int[] si = new int[d], s1 = new int[d], s2 = new int[d];
        float[] score = new float[2 * d], penalty = new float[d];
        float pnlty, dx, dy;
        ...
        int[] distx = new int[d], disty = new int[d];
        int xydiff;
